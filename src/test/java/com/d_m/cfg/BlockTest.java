...
class BlockTest {
    ...
    void createBlocks() {
        List<Quad> example =
                List.of(
                        new Quad(Operator.ASSIGN, new NameAddress(1), new ConstantAddress(1), new EmptyAddress()),
                        ...
                        new Quad(Operator.ADD, new NameAddress(1), new NameAddress(1), new ConstantAddress(1)),
